    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        switch (args[0]) {
            ...
            case "add":
                ...
                CloudNetDriver.getInstance().getPermissionManagement().modifyUser(playerToAdd.getUniqueId(), permissionUser -> {
            ...
            case "remove":
                ...
                String groupNameToRemove = args[1];
                String playerNameToRemove = args[2];
                Player playerToRemove = Bukkit.getPlayer(playerNameToRemove);
                CloudNetDriver.getInstance().getPermissionManagement().modifyUser(playerToRemove.getUniqueId(), permissionUser -> {
                    permissionUser.removeGroup(groupNameToRemove);
                });
